...
plt.bar(content_rating.index, content_rating.values, color='#2ca02c')
plt.title('Distribution of Content Ratings on Netflix')
plt.xlabel('Content in Netflix')
...
plt.bar(zon.index, zon.values, color= '#17becf')
...
direc= df['director'].value_counts().head()
plt.bar(direc.index, direc.values, color= '#2ca02c')
